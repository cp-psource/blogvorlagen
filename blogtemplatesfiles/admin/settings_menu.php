...
class blog_templates_settings_menu {
    ...
    function network_admin_page() {
        $this->page_id = add_submenu_page( 'blog_templates_main', __( 'Einstellungen', 'blog_templates' ), __( 'Einstellungen', 'blog_templates' ), 'manage_network', $this->menu_slug, array($this,'admin_options_page'));
    }
		...
		?>
			...
			<div class="wrap">
			    <form method="post" id="options">
		            ...
		            <h2><?php _e('Optionen', 'blog_templates'); ?></h2>
					
					<h3><?php _e( 'Vorlagenauswahl', 'blog_templates' ); ?></h3>
		            <table class="form-table">
		            	<?php ob_start(); ?>
			                <label for="show-registration-templates">
			                    ...
			                    <?php _e('Wenn Du diese Option auswählst, können Deine neuen Benutzer bei der Anmeldung für eine Webseite zwischen Vorlagen wählen.', 'blog_templates'); ?>
			                </label><br/>
			                <?php $this->render_row( __('Vorlagenauswahl bei Registrierung anzeigen:', 'blog_templates'), ob_get_clean() ); ?>
                        ...
                        <?php foreach ( $selection_types as $type => $label ): ?>
                            ...
                            <?php if ( $type === 'page_showcase' ) {
                                wp_dropdown_pages( array( 
                                    ...
                                    'show_option_none' => __( 'Wähle eine Seite aus', 'blog_templates' ),
                                    'option_none_value' => ''
                                ) );
                            }
                            ?>
                        ...
                        <div class="previewer-hidden-fields page_showcase-hidden-fields selection-type-hidden-fields">
                            <label style="margin-left:20px;margin-top:20px;display:block;" for="registration-templates-appearance-button-text">
                                <?php _e( '"Wähle dieses Theme" Schaltflächentext', 'blog_templates'); ?>
                        ...
                        <div class="page_showcase-hidden-fields selection-type-hidden-fields">
                            <label style="margin-left:20px;margin-top:20px;display:block;" for="registration-templates-screenshots-width">
                                <?php _e( 'Breite der Screenshots', 'blog_templates'); ?>
                            ...
                            <label style="margin-left:20px;margin-top:20px;display:block;">
                                <?php _e( 'Ausgewählte Überlagerungsfarbe', 'blog_templates'); ?><br/>
                            ...
                            <label style="margin-left:20px;margin-top:20px;display:block;">
                                <?php _e( 'Nicht ausgewählte Überlagerungsfarbe', 'blog_templates'); ?><br/>
                        ...
                        <div class="screenshot-hidden-fields screenshot_plus-hidden-fields selection-type-hidden-fields">
                            <label style="margin-left:20px;margin-top:20px;display:block;">
                                <?php _e( 'Nicht ausgewählter Screenshot Hintergrundfarbe', 'blog_templates'); ?><br/>
                            ...
                            <label style="margin-left:20px;margin-top:20px;display:block;">
                                <?php _e( 'Ausgewählter Screenshot Hintergrundfarbe', 'blog_templates'); ?><br/>
                        ...
                        <?php $this->render_row( __('Art der Auswahl', 'blog_templates'), ob_get_clean() ); ?>
			        </table>
                    
                    <?php if ( apply_filters( 'nbt_activate_categories_feature', true ) ): ?>
                        <h3><?php _e( 'Kategorien-Symbolleiste', 'blog_templates' ); ?></h3>
                        <table class="form-table">
                            <?php ob_start(); ?>
                                <label for="show-categories-selection">
                                    ...
                                    <?php _e( 'Auf dem Auswahlbildschirm wird eine neue Symbolleiste angezeigt. Benutzer können nach Vorlagenkategorien filtern.', 'blog_templates'); ?>
                                </label><br/>
                                <?php $this->render_row( __('Menü Kategorien anzeigen', 'blog_templates'), ob_get_clean() ); ?>
                            ...
                            <?php ob_start(); ?>
                                ...
                                <?php $this->render_row( __( 'Hintergrundfarbe der Symbolleiste', 'blog_templates' ), ob_get_clean() ); ?>
                            ...
                            <?php ob_start(); ?>
                                ...
                                <?php $this->render_row( __( 'Textfarbe der Symbolleiste', 'blog_templates' ), ob_get_clean() ); ?>
                            ...
                            <?php ob_start(); ?>
                                ...
                                <?php $this->render_row( __( 'Randfarbe der Symbolleiste', 'blog_templates' ), ob_get_clean() ); ?>
                            
                        </table>
                    <?php endif; ?>
		            <p><div class="submit"><input type="submit" name="save_options" class="button-primary" value="<?php esc_attr_e(__('Einstellungen speichern', 'blog_templates'));?>" /></div></p>
                </form>
			   </div>
			<?php
	    }
        ...
        */
        ...
        function admin_options_page_posted() {
            ...
            if (isset($_POST['save_options'])) {
                ...
                $this->updated_message =  __( 'Optionen gespeichert.', 'blog_templates' );
