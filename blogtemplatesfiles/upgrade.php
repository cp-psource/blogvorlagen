...
function blog_templates_upgrade_19() {
	...
	$new_options['previewer_button_text'] = isset( $options['previewer_button_text'] ) ? $options['previewer_button_text'] : __( 'Wähle diese Vorlage', 'blog_templates' );
...
function blog_templates_upgrade_20() {
		...
		if ( empty( $default_cat ) ) {
			$wpdb->insert( 
				$categories_table, 
				array( 
					'name' => __( 'Standardkategorie', 'blog_templates' ), 
					'description' => '',
					'is_default' => 1
				), 
				array( 
