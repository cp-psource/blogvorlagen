<div id="blog_template-selection">
	<h3><?php _e('Wähle eine Vorlage aus', 'blog_templates') ?></h3>
	<?php
	...
	?>
	<p><a href="<?php echo esc_url( $sign_up_url ); ?>"><?php _e('Ich möchte nur einen Benutzernamen, bitte.', 'blog_templates') ?></a></p>
	<?php
