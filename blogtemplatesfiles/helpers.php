...
function nbt_get_template_selection_types() {
	return apply_filters( 'nbt_get_template_selection_types', array(
        0 => __('Als einfaches Auswahlfeld', 'blog_templates'),
        'description' => __('Als Optionsfeldauswahl mit Beschreibungen', 'blog_templates'),
        'screenshot' => __('Als Theme Screenshot Auswahl', 'blog_templates'),
        'screenshot_plus' => __('Als Theme Screenshot Auswahl mit Titeln und Beschreibung', 'blog_templates'),
        'previewer' => __('Als Themenvorschau', 'blog_templates'),
        'page_showcase' => __('Als Schaufenster innerhalb einer Seite', 'blog_templates')
    ) );
}
