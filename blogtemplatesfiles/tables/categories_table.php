...
class blog_templates_categories_table extends WP_List_Table {
    ...
    function get_columns(){
        $columns = array(
            ...
            'description'   => __( 'Beschreibung', 'blog_templates' )
        );
        return $columns;
    }
    ...
    function column_name( $item ) {
        ...
        $actions = array(
            'edit' => sprintf( __( '<a href="%s">Bearbeiten</a>', 'blog_templates' ), $edit_link ),
            
        );


        if ( ! $item['is_default'] ) {
            $actions['delete'] = sprintf( __( '<a href="%s">Löschen</a>', 'blog_templates' ), $delete_link );
        }
