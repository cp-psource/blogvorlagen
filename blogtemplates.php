...
if ( ! is_multisite() )
	exit( __( 'Das Plugin für PS Blog Templates ist nur mit WordPress Multisite kompatibel.', 'blog_templates' ) );
		...
		?>
			<div class="template-signup-item theme-previewer-wrap <?php echo $default; ?>" data-tkey="<?php echo $tkey; ?>" id="theme-previewer-wrap-<?php echo $tkey;?>">
				...
				<div class="theme-previewer-overlay">
					...
					<button rel="nofollow" class="view-demo-button" data-blog-url="<?php echo $blog_url;?>"><?php _e( 'Demo anzeigen', 'blog_templates' ); ?></button><br/><br/>
